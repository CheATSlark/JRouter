//
//  JDrawerPresentationController.swift
//  23
//
...
class JDrawerPresentationController: UIPresentationController {
    ...
    public weak var drawerDelegate: JDrawerPresentationControllerDelegate?
    ...
    override public var frameOfPresentedViewInContainerView: CGRect {
       let pointY = self.fixedHeight == nil ? self.containerView!.frame.height/2 : self.containerView!.frame.height - self.containerView!.safeAreaInsets.bottom - self.fixedHeight!
        return CGRect(origin: CGPoint(x: 0, y: pointY), size: CGSize(width: (self.modalWidth == 0 ? self.containerView!.frame.width : self.modalWidth), height: self.containerView!.frame.height-self.topGap))
    }
    ...
    public convenience init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?, drawerDelegate: JDrawerPresentationControllerDelegate? = nil, blurEffectStyle: UIBlurEffect.Style = .light, topGap: CGFloat = 88, modalWidth: CGFloat = 0, cornerRadius: CGFloat = 20) {
